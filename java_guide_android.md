...
A: Use `? extends T` when reading (producerâ€”provides T). Use `? super T` when writing (consumerâ€”accepts T). "PECS" principle.
...
**Explanation:**
Generics implemented via type erasureâ€”generic type information removed at runtime. Replaced with bounds (or Object if unbounded).
...
**Explanation:**
Throwable
â”œâ”€â”€ Error (serious issues, shouldn't catch)
